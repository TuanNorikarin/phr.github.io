...
<html lang="en">
    ...
    <head>
        ...
        <style>
            ...
            .sidebar-menu li#aViewTestUser a {
                color: #009efb;
        ...
        <div class="content">
            <div class="row">
                <div class="col-sm-4 col-3">
                    <h4 class="page-title">Your Examination History</h4>
                </div>
        ...
        <script type="text/javascript">
            ...
            window.onload = function () {
                ...
                $.ajax({
                    ...
                    url: "https://bt-application.herokuapp.com/api/examination/findbyuserinforiddone/" + id,
                    success: function (data) {
                        ...
                        for (var i = 0; i < data.length; i++) {
                            ...
                            arrayTestRequest.push(data[i].clinicId.name);
                                ...
                                if (data[i].timeStart === arrayClick) {
                                    ...
                                    $.ajax({
                                        ...
                                        success: function (values) {
                                            localStorage.setItem("dataTestRequestId", JSON.stringify(values));
                                            $.ajax({
                                                type: "GET",
                                                dataType: "json",
                                                contentType: "application/json; charset=UTF-8",
                                                headers: {
                                                    Authorization: 'Bearer ' + token},
                                                url: "https://bt-application.herokuapp.com/api/userinfor/" + values[0].examinationId.doctorId,
                                                success: function (datas) {
                                                    localStorage.setItem("dataDoctor", JSON.stringify(datas));
                                                    window.location.href = "userViewMorePackageHistory.jsp";
                                                }})
