        ...
        <div class="content">
            <div class="row">
                ...
                <div class="col-sm-5 col-6 text-right m-b-30">
                    <a href="changePasswordDoctor.jsp" class="btn btn-primary btn-rounded"><i class="fa fa-key"></i> Change Password</a>
                    <a href="edit-profileSelfDoctor.jsp" class="btn btn-primary btn-rounded"><i class="fa fa-edit"></i> Edit Profile</a>
                </div>
